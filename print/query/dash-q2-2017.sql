...
from 
     (
      ...
      where 
            ...
            and r.kode_rekening not in (select kode_rekening from ref_acuan_barang where kode_rekening is not null and expired_date is null)
      )rpa
union
select 
...
from 
     (
      ...
      where 
            ...
            and s.soft_delete = 0      
            and r.kode_rekening like '5.2.2%'            
            and r.kode_rekening in (select kode_rekening from ref_acuan_barang where kode_rekening is not null and expired_date is null)
      )rpa      
union
select 
