select 
       ...
       ,sum(case when substr(k.kode_rekening,1,3) = '5.1' and s.id_ref_sumber_dana = 1 then r.jumlah else 0 end) as rop_1   
       ,sum(case when substr(k.kode_rekening,1,3) = '5.2' and s.id_ref_sumber_dana = 1 then r.jumlah else 0 end) as rbm_1   
       ,sum(case when substr(k.kode_rekening,1,3) = '5.1' and s.id_ref_sumber_dana = 3 then r.jumlah else 0 end) as rop_3   
       ,sum(case when substr(k.kode_rekening,1,3) = '5.2' and s.id_ref_sumber_dana = 3 then r.jumlah else 0 end) as rbm_3   
       ,sum(case when substr(k.kode_rekening,1,3) = '5.1' and s.id_ref_sumber_dana = 5 then r.jumlah else 0 end) as rop_5   
       ,sum(case when substr(k.kode_rekening,1,3) = '5.2' and s.id_ref_sumber_dana = 5 then r.jumlah else 0 end) as rbm_5   
       ,sum(case when substr(k.kode_rekening,1,3) = '5.1' and s.id_ref_sumber_dana in (33,34,35) then r.jumlah else 0 end) as rop_33   
       ,sum(case when substr(k.kode_rekening,1,3) = '5.2' and s.id_ref_sumber_dana in (33,34,35) then r.jumlah else 0 end) as rbm_33  
       ,sum(case when substr(k.kode_rekening,1,3) = '5.1' and s.id_ref_sumber_dana in (11,12) then r.jumlah else 0 end) as rop_11   
       ,sum(case when substr(k.kode_rekening,1,3) = '5.2' and s.id_ref_sumber_dana in (11,12) then r.jumlah else 0 end) as rbm_11  
       ,1 as color_id
from rapbs r
