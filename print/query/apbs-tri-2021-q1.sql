select 
       ...
       ,sum(case when dr.id_periode in (81,82,83) then dr.jumlah else 0 end) as triwulan1
       ,sum(case when dr.id_periode in (84,85,86) then dr.jumlah else 0 end) as triwulan2   
       ,sum(case when dr.id_periode in (87,88,89) then dr.jumlah else 0 end) as triwulan3   
       ,sum(case when dr.id_periode in (90,91,92) then dr.jumlah else 0 end) as triwulan4   
       ,1 as color_id
	   ,null as volume
	   ,null as satuan
	   ,null as tariff
