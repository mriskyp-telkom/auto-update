select 
       ...
       ,sum(case when dr.id_periode = 1 then dr.jumlah else 0 end) as triwulan1
       ,sum(case when dr.id_periode = 2 then dr.jumlah else 0 end) as triwulan2   
       ,sum(case when dr.id_periode = 3 then dr.jumlah else 0 end) as triwulan3   
       ,sum(case when dr.id_periode = 4 then dr.jumlah else 0 end) as triwulan4   
       ,1 as color_id
	   ,null as volume
	   ,null as satuan
	   ,null as tariff
